...
import com.leif2k.composition.data.GameRepositoryImpl
...
import com.leif2k.composition.domain.usecases.GenerateQuestionUseCase
import com.leif2k.composition.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(
    ...
    private fun formatTime(millisUntilFinished: Long): String {
        ...
        return String.format(Locale.ROOT, "%02d:%02d", minutes, leftSeconds)
    }
